...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    \begin{scope}[tdplot_rotated_coords]
        ...
        \draw[very thick, -latex, green] ({\xTest},0,0) -- ({\xTest},{\yTest},0) node[midway, right]{$Y_{tuft}$};

        \draw[very thick, -latex, blue] ({\xTest},{\yTest},0) -- ({\xTest},{\yTest},{\zTest}) node[midway, above]{$Z_{tuft}$};
